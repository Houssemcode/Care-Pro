        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 overflow-hidden">
                <div class="p-6 border-b border-slate-50 bg-slate-50/50">
                    ...
                    <p class="text-xs text-slate-500 font-medium">{{ __('Update your account\'s profile information and contact details.') }}</p>
                </div>
                ...
                <form action="{{ route('family.settings.info') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Full Name') }}</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Phone Number') }}</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Email Address') }}</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Wilaya') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Commune') }} <span class="text-rose-500">*</span></label>
                    ...
                    <div class="p-5 bg-slate-50 rounded-2xl border border-slate-100 space-y-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="text-sm font-bold text-slate-800">{{ __('Home Location Coordinates') }} <span class="text-rose-500">*</span></h4>
                                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">{{ __('Required so your caregiver can navigate to your home.') }}</p>
                            </div>
                    ...
                    <div class="pt-4 flex justify-end">
                        <button type="submit" class="px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl text-sm transition-all shadow-lg shadow-slate-900/10 active:scale-95">{{ __('Save Changes') }}</button>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 overflow-hidden">
                ...
                <form action="{{ route('family.settings.password') }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    <div>
                        <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Current Password') }}</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('New Password') }}</label>
                            <input type="password" name="password" required
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-brand-500 bg-slate-50 focus:bg-white outline-none text-sm font-medium transition-all">
                        </div>
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">{{ __('Confirm Password') }}</label>
                    ...
                    <div class="pt-4 flex justify-end">
                        <button type="submit" class="px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl text-sm transition-all shadow-lg shadow-slate-900/10 active:scale-95">{{ __('Update Password') }}</button>
                    </div>
                </form>
            </div>
        </div>
