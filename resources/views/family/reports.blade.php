...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col w-full overflow-x-hidden">
    ...
    <main class="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex flex-col page-enter">
        <div class="mb-8 sm:mb-10">
            <h2 class="text-2xl sm:text-4xl font-display font-bold text-slate-900 mb-1 sm:mb-2">My Submitted Reports</h2>
            <p class="text-sm sm:text-base text-slate-500 font-medium">Track the status of reports you've submitted against caregivers.</p>
        </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-3 mb-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 font-medium">Employee ID: {{ $report->employee_id }}</p>
                        </div>
                    </div>
