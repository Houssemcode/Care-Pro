...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col w-full overflow-x-hidden">
    ...
    <main class="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex flex-col page-enter">
        <div class="mb-8 sm:mb-10">
            <h1 class="text-3xl sm:text-4xl font-display font-extrabold text-slate-900 mb-1 sm:mb-2">My Submitted Reports</h1>
            <p class="text-sm sm:text-base text-slate-500 font-medium">Track the status of disputes or issues you've reported to the admin team.</p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 p-6 flex flex-col relative overflow-hidden transition-colors hover:border-rose-200">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 font-medium mt-0.5">
                                Caregiver: <span class="text-slate-700 font-bold">{{ $report->employee->user->name ?? 'Caregiver ID: ' . $report->employee_id }}</span> 
                ...
                @if($report->status === 'resolved' && !empty($report->admin_note))
                    <div class="mt-4 pt-4 border-t border-slate-100">
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Message from Admin</p>
            ...
            <div class="py-16 text-center bg-white rounded-2xl border border-slate-100 shadow-sm">
                ...
                <h3 class="font-display font-bold text-xl text-slate-800 mb-1">No Reports Submitted</h3>
